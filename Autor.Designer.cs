...
namespace Electronic_collection_of_books_on_programming
{
    partial class Autor
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.databaseDataSet = new Electronic_collection_of_books_on_programming.DatabaseDataSet();
            this.авторыBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.авторыTableAdapter = new Electronic_collection_of_books_on_programming.DatabaseDataSetTableAdapters.АвторыTableAdapter();
            ...
            this.dataGridView1.DataSource = this.авторыBindingSource;
            ...
            this.авторыBindingSource.DataSource = this.databaseDataSet;
            // 
            // авторыTableAdapter
            // 
            ...
            this.Name = "Autor";
            this.Text = "Авторы";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.Autor_FormClosing);
        ...
        private DatabaseDataSetTableAdapters.АвторыTableAdapter авторыTableAdapter;
